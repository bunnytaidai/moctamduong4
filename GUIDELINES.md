# Muxintang Moxibustion Wellness Center - Hướng Dẫn Vận Hành & Phát Triển (v3.9.0-debug-02)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | Trang Chủ | v3.9.0-debug-02 | `./index.html` | Cấu trúc DOM chính hiển thị cuốn sách 3D và thanh liên hệ | (Có sẵn trong source code) |
| 2 | Phong Cách Trang Chủ | v3.9.0-debug-02 | `./index.css` | Thiết kế giao diện, phối cảnh 3D, nền trong suốt, hiệu ứng lật trang tràn khung, bóng đổ 3D sâu cực mạnh và gáysách tự động ẩn trên di động dọc | (Có sẵn trong source code) |
| 3 | Kịch Bản Trang Chủ | v3.9.0-debug-02 | `./main.js` | Logic vận hành Flipbook, chặn vuốt lật bìa cũ bị huỷ bỏ (phục hồi lật bìa chuẩn) và điều chỉnh gáy sách động | (Có sẵn trong source code) |
...
| 12 | Trang Quản Trị | v3.9.0-debug-02 | `./admin.html` | Giao diện quản trị, WYSIWYG canvas, kéo thả sắp xếp trang và tuỳ chỉnh chữ nâng cao | (Có sẵn trong source code) |
| 13 | Kịch Bản Quản Trị | v3.9.0-debug-02 | `./admin.js` | Logic kéo thả, thiết lập thuộc tính nâng cao của chữ và dịch vụ, đồng bộ GitHub Cloud | (Có sẵn trong source code) |
